...
let airportData = "https://raw.githubusercontent.com/DahianaMC/Mapping_Earthquakes/Mapping_GeoJSON_Points/majorAirports.json"

// Grabbing our GeoJSON data.
d3.json(airportData).then(function(data) {
  console.log(data);
  var airportDataRetrieve = data;
  console.log(airportDataRetrieve);
// Creating a GeoJSON layer with the retrieved data.
L.geoJson(data).addTo(map);

// Grabbing our GeoJSON data.
L.geoJSON(airportDataRetrieve, {
